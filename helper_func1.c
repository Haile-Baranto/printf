 ...
 */
int printUnsigned(va_list types, char buffer[], int flags, int width,
 ...
 * Return: Number of chars printed
 */
int printOctal(va_list types, char buffer[], int flags, int width,
		int precision, int size)
{
	int i = BUFF_SIZE - 2;
	unsigned long int num = va_arg(types, unsigned long int);
...
/**
 * printHexa - Prints an unsigned number in hexadecimal notation
 * @types: Lista of arguments
 * @buffer: Buffer array to handle print
 * @flags:  Calculates active flags
 * @width: get width
 ...
 * Return: Number of chars printed
 */
int printHexa(va_list types, char buffer[], int flags, int width,
		int precision, int size)
{
